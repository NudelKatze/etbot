...
class Minecraft(Cog):
    ...
    async def status(self, inter: ApplicationCommandInteraction) -> None:
        ...
        embed.set_author(name="ETMC",
                         icon_url="https://github.com/Extended-Timeline/etbot/tree/hybrid/assets/server-icon.png")
        embed.set_thumbnail(url="https://github.com/Extended-Timeline/etbot/tree/hybrid/assets/server-icon.png")
